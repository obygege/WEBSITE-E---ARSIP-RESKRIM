...
@section('content')
        ...
        <div class="modal-dialog">
            <form class="modal-content" method="post" action="">
                ...
                <div class="modal-body">
                    ...
                    <!-- Add password field for Edit (only if reset password is checked) -->
                    <div id="passwordField" class="d-none">
                        <x-input-form name="password" :label="__('model.user.password')" type="password" />
                    </div>
                </div>
                <div class="modal-footer">
    ...
    @push('script')
        <script>
            // Handle the visibility of password fields based on reset password checkbox
            $(document).on('change', '#reset_password', function () {
                if ($(this).is(':checked')) {
